...
PYBIND11_MODULE(core, m) {
    ...
    py::class_<PSIGRID>(m, "PsiGrid", "Magnetic flux grid data and methods")
        ...
        .def("get_new_integrand", [](PSIGRID &self) -> DMatrixView
             { return DMatrixView(self.Nsize); }, "Allocate matrix to itegrate over.")
        ...
        .def("contour_integral", 
            [](PSIGRID &self, DMatrixView &integrand, double psiX, bool average = false) -> double
            { return DoFluxContourIntegral(&self, integrand.dmatrix(), psiX, average); },
            "Do a flux contour integral")
        ;

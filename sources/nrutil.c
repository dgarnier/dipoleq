...
** nrutil.c
**
** Utility subroutines as given by Numerical Recipies.
**
**
** File:		nrutil.c
** Date:		March 4, 1993
...
** Revisions:
**
**		August 6, 1993		Switched to second edition of Numerical Recipies
**
**
** L. Bai and M. Mauel -- Columbia University

   6/10/98 DTG ... modified for use with IDL
*/
...
/*
**	A global FILE pointer to the log file.
**
**
*/
...
double      **dmatrix0(long nrl, long nrh, long ncl, long nch)
{
	...
	for (ir = nrl; ir <= nrh; ir++)
		for (ic = ncl; ic <= nch; ic++)
			m[ir][ic] = 0.0;

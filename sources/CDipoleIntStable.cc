...
CDipoleIntStable::CDipoleIntStable(PLASMA *pl)
{
...
void CDipoleIntStable::ModelInput(char *key, char *val, char *init)
{
	int i;
...
void CDipoleIntStable::UpdateModel(TOKAMAK *td)
{
	int i;
	double *rr, *zz, *vv;
	double p, lastp;
...
void CDipoleIntStable::ModelDescription(FILE *fi)
{
...
void CDipoleIntStable::ModelOutput(FILE *fi)
{
	int i;
...
void CDipoleIntStable::GetPParam(TOKAMAK *td)
{
	PLASMA       *pl;
	PSIGRID      *pg;
	int           nmax, ix, iz;
